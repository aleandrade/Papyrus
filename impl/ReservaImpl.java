 ...
 * <ul>
 *   <li>{@link Model.impl.ReservaImpl#getData <em>Data</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ReservaImpl extends MinimalEObjectImpl.Container implements Reserva {
	...
	public void setData(Date newData) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.RESERVA__DATA, oldData, data));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.RESERVA__DATA:
				return getData();
		}
